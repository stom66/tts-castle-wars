...
/*SF_DATA;ver:1.04;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:1,limd:0,uamb:True,mssp:True,lmpd:False,lprd:False,rprd:False,enco:False,frtr:True,vitr:True,dbil:False,rmgx:True,rpth:0,hqsc:True,hqlp:False,tesm:0,blpr:2,bsrc:0,bdst:0,culm:2,dpts:2,wrdp:False,dith:2,ufog:False,aust:False,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:1,x:37240,y:32712,varname:node_1,prsc:2|emission-2476-OUT;n:type:ShaderForge.SFN_Multiply,id:890,x:36609,y:32726,varname:node_890,prsc:2|A-1876-RGB,B-1665-OUT;n:type:ShaderForge.SFN_Add,id:892,x:34390,y:33293,varname:node_892,prsc:2|A-1805-OUT,B-1771-OUT;n:type:ShaderForge.SFN_Fresnel,id:893,x:33924,y:33164,varname:node_893,prsc:2|EXP-1173-OUT;n:type:ShaderForge.SFN_Multiply,id:895,x:35296,y:32816,varname:node_895,prsc:2|A-1316-R,B-892-OUT;n:type:ShaderForge.SFN_Tex2d,id:896,x:34129,y:32379,ptovrint:False,ptlb:Texture,ptin:_Texture,varname:node_5931,prsc:2,tex:28c7aad1372ff114b90d330f8a2dd938,ntxv:0,isnm:False|UVIN-923-UVOUT;n:type:ShaderForge.SFN_Panner,id:923,x:33801,y:32381,varname:node_923,prsc:2,spu:0,spv:0.1|DIST-2436-OUT;n:type:ShaderForge.SFN_Add,id:974,x:35704,y:32793,varname:node_974,prsc:2|A-1898-OUT,B-1771-OUT;n:type:ShaderForge.SFN_ValueProperty,id:1173,x:33764,y:33182,ptovrint:False,ptlb:Fresnel_Exponent,ptin:_Fresnel_Exponent,varname:node_5909,prsc:2,glob:False,v1:1;n:type:ShaderForge.SFN_Tex2d,id:1316,x:35035,y:32767,ptovrint:False,ptlb:Gradient_Texture_Decay,ptin:_Gradient_Texture_Decay,varname:node_4796,prsc:2,ntxv:0,isnm:False|UVIN-1319-OUT;n:type:ShaderForge.SFN_Append,id:1319,x:34858,y:32767,varname:node_1319,prsc:2|A-1948-OUT,B-1359-OUT;n:type:ShaderForge.SFN_TexCoord,id:1336,x:33812,y:32669,varname:node_1336,prsc:2,uv:0;n:type:ShaderForge.SFN_Multiply,id:1340,x:33990,y:32755,varname:node_1340,prsc:2|A-1336-V,B-1342-OUT;n:type:ShaderForge.SFN_Vector1,id:1342,x:33812,y:32817,varname:node_1342,prsc:2,v1:0;n:type:ShaderForge.SFN_Add,id:1359,x:34164,y:32857,varname:node_1359,prsc:2|A-1340-OUT,B-2056-OUT;n:type:ShaderForge.SFN_Add,id:1497,x:34415,y:32767,varname:node_1497,prsc:2|A-896-R,B-1805-OUT;n:type:ShaderForge.SFN_TexCoord,id:1618,x:33749,y:33504,varname:node_1618,prsc:2,uv:0;n:type:ShaderForge.SFN_Tex2d,id:1620,x:33909,y:33504,ptovrint:False,ptlb:Gradient_Edge_Fake,ptin:_Gradient_Edge_Fake,varname:node_6979,prsc:2,tex:dd02884263250074096b0d1643f90f41,ntxv:0,isnm:False|UVIN-1618-UVOUT;n:type:ShaderForge.SFN_TexCoord,id:1652,x:36253,y:32948,varname:node_1652,prsc:2,uv:0;n:type:ShaderForge.SFN_Append,id:1654,x:36434,y:32888,varname:node_1654,prsc:2|A-1665-OUT,B-1652-V;n:type:ShaderForge.SFN_Tex2d,id:1656,x:36615,y:32888,ptovrint:False,ptlb:Gradient_Color,ptin:_Gradient_Color,varname:node_5350,prsc:2,ntxv:0,isnm:False|UVIN-1654-OUT;n:type:ShaderForge.SFN_Clamp,id:1665,x:36239,y:32784,varname:node_1665,prsc:2|IN-2450-OUT,MIN-1667-OUT,MAX-1666-OUT;n:type:ShaderForge.SFN_Vector1,id:1666,x:36043,y:32754,varname:node_1666,prsc:2,v1:0.95;n:type:ShaderForge.SFN_Vector1,id:1667,x:36043,y:32700,varname:node_1667,prsc:2,v1:0.05;n:type:ShaderForge.SFN_SwitchProperty,id:1771,x:34072,y:33504,ptovrint:False,ptlb:Edge_Detection_Fake,ptin:_Edge_Detection_Fake,varname:node_2692,prsc:2,on:True|A-1772-OUT,B-1620-R;n:type:ShaderForge.SFN_Vector1,id:1772,x:33868,y:33384,varname:node_1772,prsc:2,v1:0;n:type:ShaderForge.SFN_SwitchProperty,id:1805,x:34081,y:33146,ptovrint:False,ptlb:Fresnel,ptin:_Fresnel,varname:node_4079,prsc:2,on:True|A-1772-OUT,B-893-OUT;n:type:ShaderForge.SFN_SwitchProperty,id:1858,x:36795,y:32811,ptovrint:False,ptlb:Gradient_Or_Solid_Color,ptin:_Gradient_Or_Solid_Color,varname:node_6887,prsc:2,on:True|A-890-OUT,B-1656-RGB;n:type:ShaderForge.SFN_Color,id:1876,x:36402,y:32660,ptovrint:False,ptlb:Solid_Color,ptin:_Solid_Color,varname:node_5534,prsc:2,glob:False,c1:0.1764706,c2:0.5229208,c3:1,c4:1;n:type:ShaderForge.SFN_SwitchProperty,id:1898,x:35520,y:32793,ptovrint:False,ptlb:Make_Same_As_Fresnel,ptin:_Make_Same_As_Fresnel,varname:node_9542,prsc:2,on:True|A-1316-R,B-895-OUT;n:type:ShaderForge.SFN_SwitchProperty,id:1948,x:34651,y:32767,ptovrint:False,ptlb:Soft_Texture,ptin:_Soft_Texture,varname:node_9377,prsc:2,on:False|A-1497-OUT,B-896-R;n:type:ShaderForge.SFN_Slider,id:2056,x:33833,y:32939,ptovrint:False,ptlb:Decay,ptin:_Decay,varname:node_2239,prsc:2,min:0.05,cur:0.3,max:0.95;n:type:ShaderForge.SFN_Time,id:2434,x:33472,y:32378,varname:node_2434,prsc:2;n:type:ShaderForge.SFN_Multiply,id:2436,x:33643,y:32402,varname:node_2436,prsc:2|A-2434-T,B-2438-OUT;n:type:ShaderForge.SFN_ValueProperty,id:2438,x:33472,y:32526,ptovrint:False,ptlb:Pan_Speed,ptin:_Pan_Speed,varname:node_2126,prsc:2,glob:False,v1:1;n:type:ShaderForge.SFN_Multiply,id:2450,x:35931,y:32835,varname:node_2450,prsc:2|A-974-OUT,B-2452-OUT;n:type:ShaderForge.SFN_ValueProperty,id:2452,x:35704,y:32952,ptovrint:False,ptlb:Intensity,ptin:_Intensity,varname:node_8106,prsc:2,glob:False,v1:1;n:type:ShaderForge.SFN_Multiply,id:2476,x:36981,y:32811,varname:node_2476,prsc:2|A-1858-OUT,B-2477-OUT;n:type:ShaderForge.SFN_ValueProperty,id:2477,x:36795,y:32955,ptovrint:False,ptlb:Brightness,ptin:_Brightness,varname:node_4855,prsc:2,glob:False,v1:1;proporder:2477-2452-2438-1858-1656-1876-896-1316-2056-1805-1898-1173-1771-1620-1948;pass:END;sub:END;*/
